...
public class BDROM
{
    ...
    public BDROM(string path, BDInfoSettings bDInfoSettings)
    {
        ...
        //
        var pathInfo = BDCommon.IO.FileInfo.FromFullName(path);
        IDirectoryInfo tempPath;
        if (pathInfo.IsDir)
            tempPath = BDCommon.IO.DirectoryInfo.FromDirectoryName(pathInfo.FullName);
        else
        {
        ...
        if (DirectoryPLAYLIST != null)
        {
            ...
            {
                PlaylistFiles.Add(file.Name.ToUpper(), new TSPlaylistFile(this, file, _settings));
            }
        }
        ...
        if (DirectorySTREAM != null)
        {
            ...
            foreach (var file in files)
            {
                StreamFiles.Add(file.Name.ToUpper(), new TSStreamFile(file, _settings));
            }
        }
