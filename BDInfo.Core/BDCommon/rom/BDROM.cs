        ...
        public BDROM(string path, BDInfoSettings settings)
        {
            ...
            if (IsImage)
            {
                ...
                if (DiscDirectoryPLAYLIST != null)
                {
                    ...
                    {
                        PlaylistFiles.Add(file.Name.ToUpper(), new TSPlaylistFile(this, file, CdReader, _settings));
                    }
                }
                ...
                if (DiscDirectorySTREAM != null)
                {
                    ...
                    foreach (DiscFileInfo file in files)
                    {
                        StreamFiles.Add(file.Name.ToUpper(), new TSStreamFile(file, CdReader, _settings));
                    }
                }
            ...
            else
            {
                ...
                if (DirectoryPLAYLIST != null)
                {
                    ...
                    {
                        PlaylistFiles.Add(
                            file.Name.ToUpper(), new TSPlaylistFile(this, file, _settings));
                    }
                }
                ...
                if (DirectorySTREAM != null)
                {
                    ...
                    {
                        StreamFiles.Add(
                            file.Name.ToUpper(), new TSStreamFile(file, _settings));
                    }
                }
